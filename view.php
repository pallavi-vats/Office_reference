...
if ($isSingle) {
  ...
  $products = $productObj->getAll(); // returns an array
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container py-5">
  <a href="index.php" class="btn btn-secondary mb-4">&larr; Back to Product List</a>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-7">
          ...
          <p><strong>Weight:</strong>
            <?php
            $w = $product['weight'];
            echo ($w >= 1000) ? floor($w / 1000) . ' kg ' . ($w % 1000 ? $w % 1000 . ' g' : '') : "$w g";
            ?>
          </p>
        ...
        <div class="col">
          <div class="card h-100 shadow-sm">
            ...
            <div class="card-body">
              ...
              <p><strong>Price:</strong> ₹<?= number_format($product['price'], 2) ?></p>
              <a href="view.php?id=<?= $product['id'] ?>" class="btn btn-outline-primary btn-sm">View Details</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
